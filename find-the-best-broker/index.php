...
<?php $siteBase = '../'; require dirname(__DIR__) . '/includes/header.php'; ?>
<?php require dirname(__DIR__) . '/includes/ticker.php'; ?>

<main class="broker-page" id="main-content">
...
<section class="broker-section" id="broker-picks">
<div class="wrap">
...
<section class="broker-section alt" id="prop-firms">
<div class="wrap">
...
<section class="broker-section broker-guide">
<div class="wrap">
<div class="eyebrow">Selection Checklist</div>
<h2 class="sec">Look Beyond the Promotion</h2>
<div class="broker-guide-grid">
<div><span>01</span><h3>REGULATION</h3><p>Confirm the legal entity and regulator serving your country.</p></div>
<div><span>02</span><h3>COSTS</h3><p>Compare spreads, commissions, data, platform and withdrawal fees.</p></div>
<div><span>03</span><h3>RULES</h3><p>For prop firms, understand drawdown, consistency and payout rules.</p></div>
<div><span>04</span><h3>FIT</h3><p>Choose the instruments, platform and execution model you actually trade.</p></div>
</div>
<div class="affiliate-note"><strong>Affiliate disclosure:</strong> BK Traders may receive compensation when you open an account or purchase through links on these pages. This does not change your price. Trading and prop-firm evaluations involve substantial risk.</div>
</div>
</section>
</main>
