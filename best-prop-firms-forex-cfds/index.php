...
$pageIntro = 'Compare payout speed, profit share, account size, platform access and trading-rule highlights for BK Traders featured forex and CFD firms.';
$cards = [
 [
  'name'=>'AXI SELECT','mark'=>'AX','logo'=>'axi-select-white.png','category'=>'Forex / CFD Funding Program','summary'=>'A live-account funding pathway emphasizing real capital, no membership fee and a staged route toward larger allocation.',
  'values'=>['No registration or membership fees','100% free program access; standard account costs can still apply','Real funds rather than virtual capital or a demo','Funding pathway highlighted up to $1 million','Profit share highlighted up to 90% in the BK promotional graphic','No trailing or daily drawdowns highlighted'],
 ...
 [
  'name'=>'HOLA PRIME','mark'=>'HP','logo'=>'hola-prime-transparent.png','category'=>'Forex / CFD Prop Firm','summary'=>'A forex and CFD funding route focused on fast payouts, broad platform choice, flexible holding rules on select accounts and coaching access.','offer'=>'Use code EDGE for 30% off',
